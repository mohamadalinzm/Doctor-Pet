...
class AddressSetAsDefaultNotification extends Notification implements ShouldQueue
{
    use Queueable;
    ...
    public function toArray($notifiable)
    {
        return [
            ...
            'name' => $this->user->name,
            'message' => UserMessage::AddressSetAsDefaultNotification($this->user,$this->address)              ];
    }
}
